...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/polars-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/polars-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add polars polars-runtime-32 polars-runtime-64 polars-runtime-compat
# for installing globally
pixi global install polars polars-runtime-32 polars-runtime-64 polars-runtime-compat
```
...
It is possible to list all of the versions of `polars` available on your platform:
...
```
pixi search polars --channel conda-forge
```
